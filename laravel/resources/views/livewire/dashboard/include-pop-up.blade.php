    ...
    <form id="earn_form" action="{{route('dashboard-earn')}}" method="POST">
        ...
        <div class="fields">
            ...
            <div class="number_live">
                <input class="input_number" type="tel" placeholder="R$" name="value" 
                id="currency" data-prefix="R$ " data-thousands="." data-decimal="," required>
            </div>

            <input class="date_input" type="date" name='date' value="{{$date}}">
        </div>
        
        <button class="btn_create_negativo" type="submit" form="earn_form" id="submit_button">Enviar</button>
    </form>
</div>
